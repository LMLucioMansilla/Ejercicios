...
function dePalabrasAFrase(palabras) {
  ...
  for (var i = 0; i< palabras.length; i++){
   if (i === palabras.length-1){string = string + palabras[i] 
   return string;}
   else
...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   var numeroMasGrande= arrayOfNums.math.max(...arrayOfNums);
...
function cuentoElementos(array) {
   ...
   var cantidad= 0;
   for (var i = 0; i<=array.length;i++){
      array[i]>18 ; cantidad=cantidad + 1;
   }return cantidad
}
...
function todosIguales(array) {
   ...
   // Tu código:
 for(var i= 0; i<=array.length; i++){
   array[i]!= array[i+1]; return false;}
return true
}
...
function mesesDelAño(array) {
   ...
   var meses= [];
   for (var i = 0; i<array.length;i++){
      array[i] === "Enero"||"Marzo"||"Noviembre";meses.push(array[i]);
...
function mayorACien(array) {
   ...
   var masQueCien= [];
   for(var i = 0;i<= array.length; i++){
     if( array[i]>100){ masQueCien.push(array[i])}
   } return masQueCien
}
